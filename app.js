...
var data = {
    fname: "hamza",
    lname: "khan",
    email: "hafizhamzakhan87@gmail.com",
    password: "puukaa",
    age: 21,
    gender: "male",
    city: "karachi",
...
if (check == data.fname && check1 == data.lname && check2 == data.age && check3 == data.country) {
    console.log("success");
} else {
    console.log("sorry");
}
...
var user1 = new Info('HAMZA', 'KHAN', 'SALEEM KHAN', 21, 'male', 'Islam');
console.log(user1);
